/datum/access/containment_scp_008
	...
	region = ACCESS_REGION_CONTAINMENT
	access_type = ACCESS_TYPE_CONTAINMENT
	guestpass_access_prerequisites = list(ACCESS_SECURITY_LVL4)
...
/datum/access/containment_scp_035
	id = ACCESS_CONTAINMENT_SCP_035
	desc = "SCP-035 Containment"
	region = ACCESS_REGION_CONTAINMENT
	access_type = ACCESS_TYPE_CONTAINMENT
	guestpass_access_prerequisites = list(ACCESS_SECURITY_LVL4) //list(ACCESS_SCIENCE_LVL3)
