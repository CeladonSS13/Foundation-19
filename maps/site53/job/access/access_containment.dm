/datum/access/containment_scp_008
	...
	guestpass_access_prerequisites = list(ACCESS_SECURITY_LVL4, ACCESS_SECURITY_HCZ)

/datum/access/containment_scp_012
	id = ACCESS_CONTAINMENT_SCP_012
	desc = "SCP-012 Containment"
	access_type = ACCESS_TYPE_CONTAINMENT
	guestpass_access_prerequisites = list(ACCESS_SECURITY_LVL4, ACCESS_SECURITY_LCZ)
...
/datum/access/containment_scp035
	...
	access_type = ACCESS_TYPE_CONTAINMENT
	guestpass_access_prerequisites = list(ACCESS_SECURITY_LVL4, ACCESS_SECURITY_HCZ) //list(ACCESS_SCIENCE_LVL3)
